...
const solutions = [
  {
    name: "Peças",
    desc: "Catálogo de peças para máquinas embaladoras e envasadoras. Stand Up Pouch, Stick Pack, Pillow Bag e mais.",
    icon: Package,
  },
  {
    name: "Serviços",
      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <ScrollReveal>
          <SectionHeader
            ...
            subtitle="Portfólio de peças e serviços para embaladoras e envasadoras horizontais e verticais."
            align="center"
          />
        </ScrollReveal>
